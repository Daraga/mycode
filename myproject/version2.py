...
while True:
    ...
    if atk == "attack" and foeatk == "dodge":
        ...
        print ("\nYou try to attack your ooponent but their body flashes with energy blinding you. While trying to regain your vision, an energy wave slams into you")
        ...
        print ('\33[1m' + Fore.BLUE + "\nYour foe takes 1 dmg" +'\33[1m')    #adds color and bold to text
        print (Style.RESET_ALL)     #stops color change
        P2HP = P2HP - 1
        print('\33[1m' +Fore.GREEN + "Your HP = " + str(P1HP) +'\33[1m')
        print (Style.RESET_ALL)
        ...
        print ('\33[1m' + Fore.BLUE + "\nYou foe takes 1 dmg" +'\33[1m')    #adds color and bold to text
        print (Style.RESET_ALL)     #stops color change
        P2HP = P2HP - 1
        print('\33[1m' +Fore.GREEN + "Your HP = " + str(P1HP) +'\33[1m')
        print (Style.RESET_ALL)
        ...
        print ('\33[1m' + Fore.BLUE + "\nYou take 1 HP" +'\33[1m')    #adds color and bold to text
        print (Style.RESET_ALL)     #stops color change
        P1HP = P1HP - 1
        print('\33[1m' +Fore.GREEN + "Your HP = " + str(P1HP) +'\33[1m')
        print (Style.RESET_ALL)
        print ('\33[1m' + Fore.CYAN + "Foe HP = " + str(P2HP) + '\33[1m')
        print (Style.RESET_ALL)
