...
while True:
    ...
    elif throw1 =='paper' and foethrow == "scissors" :
        print ("\nYou threw " + throw1 + " and they threw " + foethrow)
        print ('\33[1m' + Fore.BLUE + "\nYou lose" +'\33[1m')    #adds color and bold to text
        print (Style.RESET_ALL)     #stops color change
        lose = lose + 1
    ...
    elif throw1 =='scissors' and foethrow == "paper" :
        print ("\nYou threw " + throw1 + " and they threw " + foethrow)
        print ('\33[1m' + Fore.BLUE + "\nYou win" +'\33[1m')    #adds color and bold to text
        print (Style.RESET_ALL)     #stops color change
        win = win + 1
    ...
    elif throw1 =='scissors' and foethrow == "rock" :
        print ("\nYou threw " + throw1 + " and they threw " + foethrow)
        print ('\33[1m' + Fore.BLUE + "\nYou lose" +'\33[1m')    #adds color and bold to text
        print (Style.RESET_ALL)     #stops color change
        lose = lose + 1
    ...
    elif throw1 == foethrow:    #what happens on ties
        print ("\nYou threw " + throw1 + " and they threw " + foethrow)
    ...
    if win == 2:
        print('\33[1m' + Fore.YELLOW + "\nCONGRATULATIONS. YOU HAVE WON THE GAME" +'\33[1m')
        break
